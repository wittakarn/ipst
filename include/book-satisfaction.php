<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<br/>
		<div class="row">
			<div id="scienceBookSection1" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection2" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection3" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection4" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection5" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection6" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection7" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection8" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection9" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
			<div id="scienceBookSection10" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div id="technologyBookSection2" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">		
			</div>
		</div>
		<div class="row">
			<div id="technologyBookSection3" class="col-md-12 col-sm-12 col-xs-12 book-satisfaction-section">		
			</div>
		</div>
		<div class="row">
	...
	<nav>
		<ul class="pager">
			<li><a class="next-tab" href="#contribute">ต่อไป</a></li>
		</ul>
	</nav>
</div>