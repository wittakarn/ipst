...
class QuotMast
{
	...
	public function create($addition){
		...
		$db = $this->dbh;
		$query = "INSERT INTO quot_mast(quot_no, year, sequence, customer_id, date, total_price, vat_price, net_price, create_user_id, create_datetime, update_count) VALUES (:quot_no, :year, :sequence, :customer_id, :date, :total_price, :vat_price, :net_price, :create_user_id, NOW(), 0)";
		...
		$stmt->bindValue(":date", str_replace(",", "", $params['s_price']), PDO::PARAM_STR);
		...
		$stmt->bindParam(":net_price", str_replace(",", "", $params['net_price']), PDO::PARAM_STR);
